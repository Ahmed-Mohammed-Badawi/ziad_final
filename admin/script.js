    ...
    if (user) {
        ...
        async function searchOrder(e) {
            ...
            if (querySnapshot.size > 0) {
                ...
                if (querySnapshot.docs[0].data().car_status < 3) {
        ...
        // Function to add 1 to the vin number if it's less than 4
        async function moveToNextStep(e) {
            e.preventDefault();
            ...
            if (querySnapshot.size > 0) {
                // Add 1 to the car_status if exists and less than 4 and if it's not exists make it 0
                if (querySnapshot.docs[0].data().car_status < 4) {
                    ...
                    await updateDoc(docRef, {
                        car_status: querySnapshot.docs[0].data().car_status + 1,
                    });
                }
                // Show the details in the form
                status.style.display = "block";
                ...
                // Update the status in the form after adding 1 to the car_status
                if (querySnapshot.docs[0].data().car_status == 0) {
                    status_0.innerText = "Status: Done";
                    status_1.innerText = "Status: in progress";
                    status_2.innerText = "Status: Not yet";
